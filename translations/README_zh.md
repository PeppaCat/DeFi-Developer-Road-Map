...
- 了解分布式账本技术的基础知识 (DLT)
- 比特币协议 [解析](https://medium.com/coinmonks/bitcoin-white-paper-explained-part-1-4-16cba783146a)
- 圆锥曲线 [密码学](https://medium.com/coinmonks/learn-how-to-code-elliptic-curve-cryptography-a952dfdc20ab)
- 阅读 [解析区块链](https://www.investopedia.com/terms/b/blockchain.asp)
- 观看[区块链 - 动画演示](https://www.youtube.com/watch?v=_160oMzblY8)

#### 以太坊

- 学习以太坊的基础知识
- 以太坊虚拟机 (EVM): 图灵完备； 外部拥有钱包 (EOA), 私钥/公钥
- 了解交易, Gas费, Metamask
- 以太坊客户端/节点, Geth客户端
- Infura 
...
- 阅读 [以太坊是如何工作的](https://medium.com/@preethikasireddy/how-does-ethereum-work-anyway-22d1df506369)
- 阅读 [此文章](https://blog.zeppelin.solutions/the-hitchhikers-guide-to-smart-contracts-in-ethereum-848f08001f05)
- 阅读 [Truffle(一种以太坊开发框架)的文档](https://truffleframework.com/docs/) / [Hardhat的文档](https://hardhat.org/getting-started/)
- 阅读[Web3的文档](https://web3js.readthedocs.io/en/1.0/) / [Ethers Documentation](https://docs.ethers.io/v5/)
- 阅读 [掌控以太坊](https://github.com/ethereumbook/ethereumbook)
- 阅读 [Solidity智能合约库](https://openzeppelin.org/api/docs/get-started.html)
...
- [ERC-918](https://eips.ethereum.org/EIPS/eip-918) - 可进行挖矿的代币标准。

#### 其他

- [ERC-165](https://eips.ethereum.org/EIPS/eip-165) - 用于发布和检测一套智能合约实现接口的规范。Creates a standard method to publish and detect what interfaces a smart contract implements.
- [ERC-725](https://eips.ethereum.org/EIPS/eip-725) - 简单代理账户的规范。A standard interface for a simple proxy account.
- [ERC-173](https://eips.ethereum.org/EIPS/eip-173) - 合约所有权的规范接口。A standard interface for ownership of contracts.
...
- 创建一个新的代码库 [GitHub](https://github.com/) / [GitLab](https://about.gitlab.com/)
- Share your code with other people know HTTP(S) protocol, request methods (GET, POST, PUT, PATCH, DELETE, OPTIONS)
- 使用Google, [Power Searching with Google](http://www.powersearchingwithgoogle.com/)
- 熟悉终端 ([Linux/Docker](https://medium.com/coinmonks/how-to-become-a-blockchain-developer-59c830e20f15)), configure your shell (bash, zsh, fish)
- 阅读一些关于算法，数据结构，区块链，以太坊，solidity的书籍
- 完成这门课程 [Ethereum and Solidity: The Complete Developer's Guide](https://www.udemy.com/ethereum-and-solidity-the-complete-developers-guide/)
- 免费的教程 [Learning Solidity](https://github.com/willitscale/learning-solidity)
- [通过Solidity入门智能合约](https://www.youtube.com/playlist?list=PLV1JDFUtrXpGvu8QHL9b78WYNSJsYNZsb)
...
#### 交易可视化，评分 & 追踪Transaction Visualization, Scoring & Tracking:
